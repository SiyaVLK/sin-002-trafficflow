# Starts each service in its own window, so any one can be closed to see how
# the rest of the system reacts. Uses JAVA_HOME when set, because the system
# Path may point at an older JDK.
...
Write-Host ""
Write-Host "Started. Give it ~10 seconds." -ForegroundColor Green
